      ...
      <div class="col-md-4">
        <div class="box box-widget widget-user-2">
          ...
          <div class="widget-user-header bg-yellow">
            ...
            <!-- /.widget-user-image -->
            <h3 class="widget-user-username">Restaurant #{{$data->id_rest}}</h3>
            <h5 class="widget-user-desc">The Lorem Ipsum Resto!</h5>
          </div>
          <div class="box-footer no-padding">
            <ul class="nav nav-stacked">
              ...
              <li><a href="#">ID Laporan <span class="pull-right badge bg-red">{{$data->id_lap_rest}}</span></a></li>
            </ul>
          </div>
        </div>
      </div>
